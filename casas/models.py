...
class Casa(models.Model):
	...
	casa_frente = models.FileField(upload_to='casas/imagenes')
	casa_cuarto = models.FileField(upload_to='casas/imagenes')
	casa_banio = models.FileField(upload_to='casas/imagenes')
	casa_otra = models.FileField(upload_to='casas/imagenes')
